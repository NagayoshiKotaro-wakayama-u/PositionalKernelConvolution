...
from libs.models import PKConvUNetAndSiteCNN,PConvUnetModel,chConcatPConvUNet,PConvLearnSite,PKConvLearnSite,PConv_ConditionalSite,branchPConv_lSite,sharePConv_lSite
import os
import pdb
...
def parse_args(isTrain=True):
    ...
    parser.add_argument('-branchlSite','--branchLearnSitePConv',action='store_true')
