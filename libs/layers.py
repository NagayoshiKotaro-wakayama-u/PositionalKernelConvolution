...
from keras.layers import Conv2D, BatchNormalization, Activation, UpSampling2D, LeakyReLU
...
class Encoder(tf.keras.layers.Layer):
    def __init__(self, filters, kernel_size, iterNum, bn=True, istraining=True, use_bias=False):
        super(Encoder, self).__init__()
        self.pconv2d = PConv2D(filters, kernel_size, strides=2, padding='same',use_bias=use_bias)
        self.count = iterNum
        self.bn = bn
